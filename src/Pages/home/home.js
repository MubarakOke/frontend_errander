        ...
        <div className=" px-6 tablet:w-[calc(100%-220px)] w-full fixed bg-[#F4F4F4] flex justify-center">
          <div className="tablet:w-[50%]  w-[80%] flex items-center justify-between">
            <Link
              ...
              to="/home/errand/"
              className={`${
                location.pathname.includes("/home/errand")
          ...
          <div className="absolute right-2">{webSocketConnected?<AiOutlineCheckCircle className="text-[25px] text-[green]"/>:<AiOutlineCloseCircle className="text-[25px] text-[red]"/>}</div>
        </div>
      </div>
